...
function App() {
  return <div id="top"><GalaxyBackground /><Navbar /><main>
    ...
    <section id="contact" className="contact-section page-grid"><SectionHeader number="05">Contact</SectionHeader><Reveal className="contact-content"><h2>Let's build something<br /><i>meaningful.</i></h2><div className="contact-bottom"><div><span>THANAKIT CHUPVIROJ</span><a href="mailto:thanakit@example.com">thanakit@example.com <ArrowUpRight size={15} /></a></div><div className="contact-links"><a href="https://github.com" target="_blank" rel="noreferrer">GitHub <ArrowUpRight size={15} /></a><a href="https://linkedin.com" target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={15} /></a></div><div className="contact-mark"><ArrowUpRight size={50} strokeWidth={1} /></div></div></Reveal></section>
  </main><footer className="footer page-grid"><span>© 2026 THANAKIT CHUPVIROJ</span><span>BUSINESS ANALYSIS · UX/UI · FRONTEND</span><span>STATUS: OPEN FOR INTERNSHIP</span></footer></div>
}
