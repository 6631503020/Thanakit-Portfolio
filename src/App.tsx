...
import profileImage from '../pic/me.png'
...
function App() {
  return <div id="top"><GalaxyBackground /><Navbar /><main>
    ...
    <section id="about" className="content-section page-grid"><SectionHeader number="01">About Me</SectionHeader><div className="about-layout"><div className="about-visual"><Reveal direction="left"><h2>Understanding needs.<br /><i>Designing possibilities.</i></h2></Reveal><Reveal className="about-photo"><img src={profileImage} alt="Thanakit Chupviroj" /></Reveal></div><Reveal className="about-copy"><p>My Name is Thanakit Chupviroj. Fourth-year Software Engineering student aspiring to be an IT Business Analyst. Experienced in requirement gathering, analyzing market viability, and bridging the gap between technical teams and business stakeholders.</p><p>I enjoy turning complex needs into clear, intuitive, and functional digital experiences.</p><div className="tag-list"><span>Business Analysis</span><span>UX/UI Design</span><span>Web Design</span><span>React</span><span>TypeScript</span><span>Figma</span></div><a className="resume-button" href={resumePdf} download="Thanakit-Chupviroj-Resume.pdf" target="_blank" rel="noreferrer"><Download size={16} /> Download Resume <ArrowUpRight size={15} /></a></Reveal></div></section>
